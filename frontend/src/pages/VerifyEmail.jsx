...
//     setVerifying(true);
//     try {
//       const res = await axios.get(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/auth/verify/${token}`);
...
function VerifyEmail() {
  ...
  const handleResendVerification = async () => {
    ...
    if (email) {
      setResending(true);
      try {
        const res = await axios.post('https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/auth/resend-verification', {
          email: email
        });
