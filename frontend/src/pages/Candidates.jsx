...
function Candidates({ user }) {
  ...
  const fetchCandidates = async (query = "") => {
    ...
    try {
      const url = query
        ? `https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates/search?q=${encodeURIComponent(query)}`
        : "https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates";
  ...
  const approveCandidate = async (candidateId) => {
    try {
      await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates/${candidateId}/approve`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const disqualifyCandidate = async (candidateId) => {
    try {
      await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates/${candidateId}/disqualify`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const deleteCandidate = async (candidateId) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates/${candidateId}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
  ...
  const fetchElectionsAndUsers = async () => {
    try {
      const [electionRes, userRes] = await Promise.all([
        axios.get("https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/elections", {
          headers: { Authorization: `Bearer ${token}` },
        }),
        axios.get("https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/all", {
          headers: { Authorization: `Bearer ${token}` },
        }),
      ]);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/candidates", data, {
        headers: {
