...
const Users = ({ user }) => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            const response = await axios.get(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users?${params}`, {
    ...
    const handleSuspendUser = async (userId) => {
        try {
            await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}/suspend`, {}, {
                headers: getAuthHeaders()
            });
    ...
    const handleActivateUser = async (userId) => {
        try {
            await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}/activate`, {}, {
                headers: getAuthHeaders()
            });
    ...
    const handleDeleteUser = async (userId) => {
        ...
        if (result.isConfirmed) {
            try {
                await axios.delete(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}`, {
                    headers: getAuthHeaders()
                });
    ...
    const handleChangeRole = async (userId, newRole, options = { suppressToast: false }) => {
        try {
            await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}/role`, 
                { role: newRole }, 
                { headers: getAuthHeaders() }
            );
    ...
    const handleExportUsers = async () => {
        try {
            ...
            try {
                const response = await axios.get('https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/export', {
                    headers: getAuthHeaders(),
                    responseType: 'blob'
                });
                ...
                const response = await axios.get('https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users?limit=10000', {
                    headers: getAuthHeaders()
                });
    ...
    const viewUserDetails = async (userId) => {
        try {
            const userResponse = await axios.get(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}`, {
                headers: getAuthHeaders()
            });
    ...
    const handleUpdateUser = async () => {
        try {
            ...
            await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${idToUpdate}`, editUser, {
                headers: getAuthHeaders()
            });
    ...
    const handleVerifyToggle = async (userId, shouldVerify) => {
        try {
            await axios.put(`https://legendary-space-journey-74p9qrwrq99hpppj-5000.app.github.dev/api/users/${userId}`, { isVerified: shouldVerify }, {
                headers: getAuthHeaders()
            });
