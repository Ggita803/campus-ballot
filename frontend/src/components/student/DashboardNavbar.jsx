...
const DashboardNavbar = ({ user, notifications, onProfile, onLogout }) => (
  ...
  >
    <div className="container-fluid">
      <span className="navbar-brand d-flex align-items-center gap-2" style={{ lineHeight: '56px' }}>
        <FaUserGraduate size={22} />
        <span className="fw-bold fs-5 d-none d-md-inline">Student Portal</span>
        <span className="fw-bold fs-6 d-md-none">Portal</span>
      </span>
